...
| **subscription_licenses** | `//page[@name='elementos_y_licencias']/notebook` inside | Página `elementos_y_licencias` con un **notebook** (añade Licencias del Equipo y Licencias del Usuario) |
| **auto_link_components** | `//page[@name='elementos_y_licencias']` inside | Página `elementos_y_licencias` (botón Vincular componentes) |
