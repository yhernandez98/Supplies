...
from . import component_change  # Antes de stock.lot (maintenance.component.change)
from . import customer_inventory_lot
from . import res_partner
from . import stock_lot_maintenance
from . import maintenance_order
from . import mesa_ayuda_service_panel
from . import mesa_ayuda_technician_panel
