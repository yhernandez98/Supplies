...
from . import add_equipment_wizard
...
from . import customer_query_wizard
from . import service_order_solicitudes_wizard
from . import service_order_retiro_usuario_equipo_wizard
